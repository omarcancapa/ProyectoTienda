					...
					<form class="form-horizontal" action="{{url('/save-category')}}" method="post">
					  ...
					  <fieldset>
						<div class="control-group">
						  <label class="control-label" for="date01">Nombre de Categoria</label>
						  <div class="controls">
						...
						<div class="control-group hidden-phone">
						  <label class="control-label" for="textarea2">Descripcion de Categoria</label>
						  <div class="controls">
							<textarea class="cleditor" name="category_description" rows="3" required=""></textarea>
						  </div>
						</div>
						<div class="control-group hidden-phone">
						  <label class="control-label" for="textarea2">Estado de Publicacion</label>
						  <div class="controls">
